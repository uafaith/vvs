...
Initial Supply: 2 000 000 000 000 000 Tokens
...
contract UAFaith is BEP20, LockToken {
    ...
    uint256 public _totalSupply = 2_000_000_000_000_000 * (10**18);
    ...
    address payable public _marketingWalletAddress = payable(0x1988b0d0dC71C321C9334c018a78BfC8172214E6);
    address payable public _charityWalletAddress = payable(0x7159634Ec7803Ae585725C87A1D83E94DdE1035B);
    address payable public _buybackWalletAddress = payable(0x7a02655BE5aB566f91b0452953F288DF0a1a282f);
